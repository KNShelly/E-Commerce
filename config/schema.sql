...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2025 at 12:08 PM
...
INSERT INTO `products` (`id`, `sku`, `name`, `slug`, `description`, `price`, `sale_price`, `stock`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'SKU-001', 'Sample Product', 'sample-product', 'This is a sample product.', 19.99, NULL, 100, 1, '2025-10-31 07:48:26', NULL);
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `last_name`, `phone`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'admin@example.com', 'REPLACE_WITH_HASH', 'System', 'Admin', NULL, 1, '2025-10-31 07:48:25', NULL),
(2, 'customer@example.com', 'REPLACE_WITH_HASH', 'Jane', 'Customer', NULL, 1, '2025-10-31 07:48:25', NULL);
