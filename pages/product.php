            ...
            <div class="col-lg-6">
                <div class="product-details">
                    ...
                    <?php if (isset($product['category'])): ?>
                        <span class="badge elegant-badge mb-3"><?php echo htmlspecialchars($product['category']); ?></span>
                    <?php endif; ?>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card h-100 product-card">
                            <img src="<?php echo !empty($related['image_path']) ? htmlspecialchars($related['image_path']) : 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80'; ?>" 
                                 class="card-img-top" 
